...
import { FindCustomersSkeleton } from '@/components/skeleton-loader';

export default function FindCustomersPage() {
  const { findCustomersUnlocked, potentialCustomers, streak, initialized } =
    useAppStore();

  // Show skeleton while data is loading
  if (!initialized) {
    return <FindCustomersSkeleton />;
  }
        ...
        <div className="max-w-md w-full bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/50 dark:to-red-950/50 rounded-3xl p-8 shadow-2xl border-2 border-orange-200 dark:border-orange-800">
          <div className="text-center space-y-6">
            ...
            <p className="text-lg text-foreground/80">
              ...
              by maintaining a <span className="font-bold">10-day streak</span>
            </p>
            ...
            <p className="text-sm text-muted-foreground">
              Upload evidence daily to build your streak and unlock this
              powerful feature
            </p>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground mb-4">
            Use your 🍍 pineapples to reveal potential customers and add them to
            your leads
          </p>
